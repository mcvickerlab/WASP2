#!/bin/bash
# =============================================================================
# WASP2 UNIFIED PIPELINE BENCHMARK - 15M reads WITH INDELS
# Same as run_15m_unified_benchmark.sh but with include_indels=True
# =============================================================================
...
echo "=============================================="
echo "WASP2 UNIFIED - 15M reads + INDELS benchmark"
...
OUTPUT_DIR="${WASP2_DIR}/benchmarking/results/unified_15m_indels_${TIMESTAMP}"
mkdir -p "${OUTPUT_DIR}"
...
# -----------------------------------------------------------------------------
# STEP 1: WASP2 unified make-reads WITH INDELS
# -----------------------------------------------------------------------------
echo ""
echo "STEP 1: WASP2 unified make-reads (WITH INDELS)..."
...
echo ""
echo "=============================================="
echo "BENCHMARK RESULTS - 15M reads (WITH INDELS)"
echo "=============================================="
